...
| Live BSC trading during competition week | Operationally pending | Wallet has rehearsal floor stables and gas; full stake/top-up and explicit live flip remain gated. |
...
| Portfolio worth above $1 | Done for rehearsal | Wallet holds in-scope BSC floor stables; full scored-week sizing still needs top-up. |
...
2. Top up the TWAK wallet to the final scored-week stake.
3. Run the production live cutover only with isolated `SOLVENT_DATA_DIR`.
4. Record the real CMC x402 proof receipt and live rehearsal tx in the demo.
